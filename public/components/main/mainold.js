...
export class Main extends React.Component {
  ...
  componentDidMount() {
    ...
    */
    ...
    httpClient.get('../api/csvGenerator/example').then((resp) => {
        ...
        <EuiPageBody>
          <EuiPageHeader>
            <EuiTitle size="l">
              <h1>
                <FormattedMessage
                  id="csvGenerator.helloWorldText"
          ...
          <EuiPageContent>
            <EuiPageContentHeader>
              <EuiTitle>
                <h2>
                  <FormattedMessage
                    id="csvGenerator.congratulationsTitle"
